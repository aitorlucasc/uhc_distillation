...
"""
This script is about a distillation problem. It trains two teachers with a ResNet50 for the MNIST dataset.
...
teacher0to4 = ResNet_Model(num_classes=5)
...
teacher5to9 = ResNet_Model(num_classes=5)
...
if args["save_teachers"]:
    torch.save(teacher0to4, args["teachers_path"] + "teacher0to4_resnet.pt")
    torch.save(teacher5to9, args["teachers_path"] + "teacher5to9_resnet.pt")
