...
parser.add_argument('--t1', default="/home/student/noel_aitor/mnist/teachers/teacher0to4_CNN.pt")
parser.add_argument('--t2', default="/home/student/noel_aitor/mnist/teachers/teacher5to9_CNN.pt")
parser.add_argument('--network_type', default="NN")
args = vars(parser.parse_args())

logging.basicConfig(filename=f"/home/student/noel_aitor/logs/get_Qs_CNN.log",
...
for i, img in enumerate(images_train):
    z1 = teacher1(img.view(-1, 1, 28, 28).float())
    z2 = teacher2(img.view(-1, 1, 28, 28).float())
...
u_df.to_pickle(f"/home/student/noel_aitor/mnist/logits/mnist_qs_CNN.csv")
